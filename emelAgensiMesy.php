                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td>
                              ...
                              <u class="dotted" style="border-bottom: 1px dashed #999; text-decoration: none; "><b><?php echo $agensi_nama; ?> (<?php echo $agensi_id; ?>)</b></u></p><br/>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                        ...
                        <tr>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                <tr>
                                    <td><?php echo '<a href="http://mytask.mbi.gov.my/ejadualv1/terimaMesy.php?ID='.$ID.'&agensi_id='.$agensi_id.'" target="_blank">TERIMA</a>'; ?></td>
                                </tr>
                                </tbody>
                            </table>
                            </td>
