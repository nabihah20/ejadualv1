            ...
            <div class="collapse navbar-collapse" id="menu">
              <ul class="nav navbar-nav navbar-right">
                <li class="active"><a href="index.php #intro">Home</a></li>
                  ...
                  <span class="glyphicon glyphicon-user"></span>&nbsp;Hi <?php echo $userRow['user_id']; ?>&nbsp;<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a href="profile.php"><span class="glyphicon glyphicon-user"></span>&nbsp;Profil Saya</a></li>
                    <li><a href="logout.php?logout=true"><span class="glyphicon glyphicon-log-out"></span>&nbsp;Daftar Keluar</a></li>
                  </ul>
              </li>
              </ul>
            </div>
